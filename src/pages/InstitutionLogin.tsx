...
export default function InstitutionLogin() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setIsLoading(true);
    const result = await validateLogin(email.trim(), password, "institution");
    setIsLoading(false);
        ...
        <main className="flex flex-1 flex-col items-center justify-center px-4 py-12">
          <div className="w-full max-w-md space-y-8">
            <div className="text-center lg:text-left">
              <span className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-2xl bg-primary/10 text-primary lg:hidden">
                <Building2 className="h-6 w-6" />
              </span>
              <h1 className="text-2xl font-semibold tracking-tight">Institution sign in</h1>
              <p className="mt-2 text-sm text-muted-foreground">
                Issue and manage digital certificates for your institution.
              </p>
            </div>
            ...
            <div className="glass-panel rounded-2xl p-6 sm:p-8">
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  <Label htmlFor="inst-login-email">Email</Label>
                  <Input
                    id="inst-login-email"
                    type="email"
                    autoComplete="email"
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    <Label htmlFor="inst-login-pass">Password</Label>
              ...
              <p className="mt-6 text-center text-sm text-muted-foreground">
                New institution?{" "}
                <Link to="/signup/institution" className="font-medium text-primary hover:underline">
                  Create an account
                </Link>
              </p>
            </div>
